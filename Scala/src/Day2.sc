...
def wrappingPapper (l: Int, w:Int, h:Int): Int ={
  val surfaces = List(l*w, w * h, h * l).sorted.head
  val surfaceArea = 2*l*w + 2*w*h + 2*h*l
  surfaceArea+surfaces
}

wrappingPapper(2,3,4)
wrappingPapper(2,3,4) == 58
wrappingPapper(1,1,10) == 43
wrappingPapper(5,50,1) == 615