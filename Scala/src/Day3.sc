...
// how to infinite two dimensional, what is the most appropriate data structure
// looks like yielding is the way to go to deliver presents



def howManyHousesAtLeastOnePresent